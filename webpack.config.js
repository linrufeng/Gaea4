...
module.exports = (env,argv)=> {
    ...
    if(argv.mode === 'production'){
        ...
        webpackConfig.plugins = (webpackConfig.plugins || []).concat([
            ...
            new CopyWebpackPlugin([
                { from: path.join(__dirname, "./src/service-worker.js"), to: path.join(__dirname, "./build/service-worker.js") }
            ]),
        ...
        webpackConfig.plugins = (webpackConfig.plugins || []).concat([
            ...
            },{ filepath: require.resolve('./static/service-worker.js'),includeSourcemap: false}]),           
            // new CopyWebpackPlugin([     
